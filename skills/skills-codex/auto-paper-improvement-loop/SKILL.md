...
description: Autonomously improve a generated paper via the configured Codex reviewer review → implement fixes → recompile, for 2 rounds. Use when user says "改论文", "improve paper", "论文润色循环", "auto improve", or wants to iteratively polish a generated paper.
metadata:
...
Send the full paper text AND compiled PDF to the configured Codex reviewer:

```text
spawn_agent:
  task_name: auto_paper_improvement_loop_review
  fork_turns: none
  message: |
...
<details>
<summary>the configured Codex reviewer Review (Round 1)</summary>
...
<details>
<summary>the configured Codex reviewer Review (Round 2)</summary>
