...
```
python3 tools/run_state.py start  <root> <run_id> --phases "W1,W1.5,W2,W3" --executor "<actual-executor-model>" --provisional-advances
python3 tools/run_state.py set    <root> <run_id> W1 done --artifact idea-stage/IDEA_REPORT.md
python3 "$RUN_STATE" start <root> <run_id> --phases W1,W1.5,W2 --executor "<actual-executor-model>" --provisional-advances
python3 "$RUN_STATE" mark-provisional <root> <run_id> W1 --verdict-id agent:019e... --reviewer "<actual-reviewer-model>"
