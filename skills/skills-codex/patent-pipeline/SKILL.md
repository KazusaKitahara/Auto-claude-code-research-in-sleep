...
This runs 2 rounds of examiner-style review via the configured Codex reviewer. The examiner evaluates clarity, written description, enablement, novelty, non-obviousness, and claim scope.
