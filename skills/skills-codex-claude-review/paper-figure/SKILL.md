---
name: "paper-figure"
description: "Create publication figures, statistical plots, and tables from experiment results. Use for research data visualization; use figure-spec for structural diagrams. Uses the configured Claude review backend."
---
