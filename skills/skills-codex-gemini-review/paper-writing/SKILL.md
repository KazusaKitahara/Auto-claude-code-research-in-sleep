---
name: "paper-writing"
description: "Run the complete manuscript pipeline from research report through outline, figures, LaTeX drafting, review, and final PDF checks. Use when the user requests the full paper-writing workflow. Uses the configured Gemini review backend."
---
